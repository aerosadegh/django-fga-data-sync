...
# ==========================================
# THE EXTERNAL CONTEXT (State checked by the Dashboard)
# ==========================================
type organization
  relations
    # 1. Base Roles
    define admin: [user]
    define finance_admin: [user] or admin
    define member: [user] or finance_admin

    # 2. Permissions (The Stateless Dashboard checks this!)
    define can_view_finance_dashboard: finance_admin

# ==========================================
# THE OWNED DATA (State synced by the Finance App)
# ==========================================
type invoice
  relations
...
type expense
  relations
    ...
    # 3. Permissions (Optional: cascading from the Org)
    define can_read_expense: spender or finance_admin from organization
```
