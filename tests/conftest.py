...
def mock_fga_client(mocker):
    ...
    mocker.patch("fga_data_sync.serializers.get_fga_client", return_value=mock_client)
    mocker.patch("fga_data_sync.batchers.get_fga_client", return_value=mock_client)
    return mock_client
